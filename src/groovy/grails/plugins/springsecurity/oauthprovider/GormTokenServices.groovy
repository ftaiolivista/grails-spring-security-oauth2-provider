...
class GormTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
	...
	public OAuth2AccessToken createAccessToken(OAuth2Authentication authentication) throws AuthenticationException {
		...
		OAuth2AccessToken out
		
		test.Role.withTransaction { status ->
	...
	public OAuth2AccessToken getAccessToken(OAuth2Authentication authentication) {
		OAuth2AccessToken out 
		test.Role.withTransaction { status ->
			out = tokenStore.getAccessToken(authentication)
		}
		out	
	}
	 ...
	 */
	public int getAccessTokenValiditySeconds(AuthorizationRequest authorizationRequest) {
	 ...
	 */
	public int getRefreshTokenValiditySeconds(AuthorizationRequest authorizationRequest) {
		if (clientDetailsService != null) {
			ClientDetails client = clientDetailsService.loadClientByClientId(authorizationRequest.getClientId());
